            ...
            <div class="card-body">
                <div class="settings">
                    ...
                    <div class="form-group form-row align-items-center">
                        ...
                        <div class="col-sm pl-sm-3 pr-sm-5 order-last order-sm-2">
                            <input type="number" class="form-control" name="nSort" id="nSort" value="{if isset($Betreff->nSort)}{$Betreff->nSort}{/if}" tabindex="4" />
                        </div>
                    </div>
                </div>
            </div>
            <div class="card-footer save-wrapper">
                <div class="row">
                    <div class="ml-auto col-sm-6 col-xl-auto">
                        <button type="button" onclick="window.location.href='{$shopURL}{$route}?tab=subjects'" class="btn btn-outline-primary btn-block">
                            {__('cancelWithIcon')}
                        </button>
                    </div>
