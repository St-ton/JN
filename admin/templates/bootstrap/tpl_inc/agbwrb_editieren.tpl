        ...
        <form name="umfrage" method="post" action="agbwrb.php">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">{__("agbwrb")} {foreach name=sprachen from=$Sprachen item=sprache}{if $sprache->kSprache == $smarty.session.kSprache}({$sprache->cNameDeutsch}){/if}{/foreach}{if isset($kKundengruppe)} f&uuml;r Kundengruppe {$kKundengruppe} editieren{/if}</h3>
                </div>
                <table class="list table" id="formtable">
                    <tr>
                        <td><label for="cAGBContentText">{__("agb")} (Text):</label></td>
                        <td>
                    ...
                    <tr>
                        <td><label for="cAGBContentHtml">{__("agb")} (HTML):</label></td>
                        <td>
                    ...
                    <tr>
                        <td><label for="cWRBContentText">{__("wrb")} (Text):</label></td>
                        <td>
                    ...
                    <tr>
                        <td><label for="cWRBContentHtml">{__("wrb")} (HTML):</label></td>
                        <td>
                    ...
                    <tr>
                        <td><label for="cWRBFormContentText">{__("wrbform")} (Text):</label></td>
                        <td>
                    ...
                    <tr>
                        <td><label for="cWRBFormContentHtml">{__("wrbform")} (HTML):</label></td>
                        <td>
                    ...
                    <tr>
                        <td><label for="cDSEContentText">{__("dse")} (Text):</label></td>
                        <td>
                    ...
                    <tr>
                        <td><label for="cDSEContentHtml">{__("dse")} (HTML):</label></td>
                        <td>
