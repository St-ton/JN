...
{block name='checkout-inc-steps'}
    ...
    {if $bestellschritt[1] != 3}
        {nav pills=true fill=true class="mb-7 nav-wizard"}
            <li class="nav-item nav-link {if $step1_active}active{/if}">
            ...
            <li class="nav-item nav-link {if $step2_active}active{/if} {if $step1_active}nav-todo{/if}">
            ...
            <li class="nav-item nav-link {if $step3_active}active{/if} {if $step1_active || $step2_active}nav-todo{/if}">
