...
// Retouren
const RETOURE_STATUS_ABGELEHNT      = -1;
const RETOURE_STATUS_OFFEN          = 1;
const RETOURE_STATUS_IN_BEARBEITUNG = 2;
const RETOURE_STATUS_AKZEPTIERT     = 3;
const RETOURE_STATUS_ABGESCHLOSSEN  = 4;
const PRODUCT_NOT_RETURNABLE        = 'itemNotReturnable';
