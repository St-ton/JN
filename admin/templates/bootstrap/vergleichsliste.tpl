                            ...
                            <tr class="tab_bg{$smarty.foreach.letzten20.iteration%2}">
                                ...
                                <td class="">
                                    {foreach name=letzten20pos from=$oVergleichsliste20->oLetzten20VergleichslistePos_arr item=oVergleichslistePos20}
                                        <a href="{Shop::getURL()}/index.php?a={$oVergleichslistePos20->kArtikel}" target="_blank">{$oVergleichslistePos20->cArtikelName}</a>{if !$smarty.foreach.letzten20pos.last}{/if}
                                        <br />
                                    {/foreach}
                                </td>
                    ...
                    <table class="bottom table">
                        ...
                        {foreach name=top from=$TopVergleiche item=oVergleichslistePosTop}
                            <tr class="tab_bg{$smarty.foreach.top.iteration%2}">
                                <td class="TD1">
                                    <a href="{Shop::getURL()}/index.php?a={$oVergleichslistePosTop->kArtikel}" target="_blank">{$oVergleichslistePosTop->cArtikelName}</a>
                                </td>
