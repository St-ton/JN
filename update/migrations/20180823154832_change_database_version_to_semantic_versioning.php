...
class Migration_20180823154832 extends Migration implements IMigration
{
    ...
    public function up()
    {
        ...
        $db->query('ALTER TABLE `tversion` CHANGE `nVersion` `nVersion` varchar(20) NOT NULL', \DB\ReturnType::DEFAULT);
    }

    public function down()
    {
        $db = Shop::Container()->getDB();
        $db->query('ALTER TABLE `tversion` CHANGE `nVersion` `nVersion` int(10) DEFAULT NULL', \DB\ReturnType::DEFAULT);
    }
}