...
{if $bestellschritt[1] != 3}
    <ul class="nav nav-wizard row">
        <li class="{if $bestellschritt[1] == 1 || $bestellschritt[2] == 1}active col-xs-8{else}col-xs-2{/if} col-md-4">
            ...
            <a href="{get_static_route id='bestellvorgang.php'}?editRechnungsadresse=1">{lang section='account data' key='billingAndDeliveryAddress'}</a>
            {else}
        ...
        <li class="{if $bestellschritt[3] == 1 || $bestellschritt[4] == 1}active col-xs-8{else}col-xs-2{/if} col-md-4">
            ...
            <a href="{get_static_route id='bestellvorgang.php'}?editZahlungsart=1">{lang section='account data' key='shippingAndPaymentOptions'}</a>
            {else}
