...
//        }
    ...
    public function fuelleArtikel(
        ...
        $tmpProduct = $db->getSingleObject($productSQL->getStatement(), $productSQL->getParams());
        ...
        if ($tmpProduct->cSeo === null && \EXPERIMENTAL_MULTILANG_SHOP === true) {
            ...
            $tmpProduct = $db->getSingleObject($statement, $productSQL->getParams());
        }
     ...
     * @return SqlObject
     */
    private function getBomSQL(int $productID, DbInterface $db): SqlObject
    {
     ...
     * @return SqlObject
     */
    private function getProductSQL(int $productID, int $customerGroupID, DbInterface $db): SqlObject
    {
        $langID             = $this->kSprache;
