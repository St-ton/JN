...
<div id="content">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-auto">
                    <form name="suchspecialoverlay" method="post" action="{$shopURL}{$route}" class="inline_block">
                        {$jtl_token}
                        <div class="form-row">
    ...
    {if $oSuchspecialOverlay->getType() > 0}
        <form name="einstellen" method="post" action="{$shopURL}{$route}" enctype="multipart/form-data" onsubmit="checkfile(event)">
            {$jtl_token}
            <input type="hidden" name="suchspecialoverlay" value="1" />
