...
<div id="content">
    <form name="news" method="post" action="{$shopURL}{$route}" enctype="multipart/form-data">
        {$jtl_token}
                                        ...
                                        <div class="well col-xs-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <div class="input-group-addon">
                                                    <a href="{$shopURL}{$route}?news=1&newskategorie_editieren=1&kNewsKategorie={$oNewsKategorie->getID()}&delpic={$file->cName}&token={$smarty.session.jtl_token}" title="{__('delete')}"><i class="fas fa-trash-alt"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    {/foreach}
