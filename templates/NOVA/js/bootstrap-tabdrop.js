...
!function ($) {
    ...
    var TabDrop = function (element, options) {
        ...
        if (options.align === "left")
            this.dropdown = $('<li class="dropdown d-none pull-left tabdrop"><a class="btn" data-toggle="dropdown" href="javascript:;"><span class="display-tab"></span></a><ul class="dropdown-menu"></ul></li>');
        else
            this.dropdown = $('<li class="dropdown d-none pull-right tabdrop"><a class="btn" data-toggle="dropdown" href="javascript:;"><span class="display-tab"></span></a><ul class="dropdown-menu"></ul></li>');
