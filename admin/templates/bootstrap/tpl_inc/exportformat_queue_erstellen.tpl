        ...
        {if $oExportformat_arr|@count > 0}
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">{if isset($oCron->kCron) && $oCron->kCron > 0}{__("save")}{else}{__("exportformatAdd")}{/if}</h3>
                </div>
                ...
                <div class="panel-footer">
                    <div class="btn-group">
                        <button name="action[erstellen_eintragen]" type="submit" value="1" class="btn btn-primary"><i class="fa fa-save"></i> {if isset($oCron->kCron) && $oCron->kCron > 0}{__("save")}{else}{__("exportformatAdd")}{/if}</button>
