...
{else}
    {include file='snippets/opc_mount_point.tpl' id='editor_news_article_prepend'}
    <article itemprop="mainEntity" itemscope itemtype="https://schema.org/BlogPosting">
        ...
        {include file='snippets/opc_mount_point.tpl' id='editor_news_content_prepend'}
        <div itemprop="articleBody" class="row">
            <div class="col-xs-12">
                {$oNewsArchiv->cText}
            </div>
        </div>
        {include file='snippets/opc_mount_point.tpl' id='editor_news_content_append'}
        ...
        {if isset($Einstellungen.news.news_kommentare_nutzen) && $Einstellungen.news.news_kommentare_nutzen === 'Y'}
            ...
            {/if}
        {/if}
        {include file='snippets/opc_mount_point.tpl' id='editor_news_comments_append'}
    </article>
{/if}
