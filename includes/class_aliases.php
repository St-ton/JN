...
class_alias(\JTL\Extensions\DownloadLocalization::class, 'DownloadSprache', true);
...
class_alias(\JTL\Extensions\SelectionWizard::class, 'AuswahlAssistent', true);
class_alias(\JTL\Extensions\SelectionWizardQuestion::class, 'AuswahlAssistentFrage', true);
class_alias(\JTL\Extensions\SelectionWizardGroup::class, 'AuswahlAssistentGruppe', true);
class_alias(\JTL\Extensions\SelectionWizardLocation::class, 'AuswahlAssistentOrt', true);
