    ...
    <div class="box-body panel-body">
        {if empty($smarty.session.Kunde->kKunde)}
            <form action="{get_static_route id='jtl.php' secure=true}" method="post" class="form box_login evo-validate">
                ...
                options=[
                'email', 'email-box-login', 'email', null,{lang key='emailadress'}, true, null, null, true
                ]
                }
                {include file='snippets/form_group_simple.tpl'
                options=[
                'password', 'password-box-login', 'passwort', null,{lang key='password' section='account data'}, true, null, null, true
                ]
                }
