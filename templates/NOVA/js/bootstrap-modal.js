    ...
    define(["jquery"], function ($) {
        ...
        function getModalInstance() {
            ...
            function createModalElement() {
                ...
                + "   <div class='modal-header'><div class='modal-title h4'></div><button type='button' class=\"x close\" data-dismiss='modal'><span aria-hidden='true'>&times;</span><span class='sr-only'>Close</span></button></div>"
                + "  </div>"
                + " </div>"
                + "</div>")
