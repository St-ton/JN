    ...
    <div class="card">
        <div class="card-body">
            <div class="form-group">
                <form method="post" action="{$shopURL}{$route}" class="form-inline">
                    {$jtl_token}
                    <div class="row">
                        ...
                        <tr>
                            <td>
                                {if $usedCouponOrder.kKupon}
                                    <a href="{$shopURL}{$route}?&kKupon={$usedCouponOrder.kKupon}&token={$smarty.session.jtl_token}">{$usedCouponOrder.cName}</a>
                                {else}
