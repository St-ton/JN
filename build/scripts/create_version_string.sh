...
create_version_string()
{
    ...
    export MAJOR_MINOR_VERSION="${SHOP_VERSION_MAJOR}${SHOP_VERSION_MINOR}";
    ...
    sed -i "s/'JTL_VERSION', '.*'/'JTL_VERSION', '${MAJOR_MINOR_VERSION}'/g" ${REPO_DIR}/includes/defines_inc.php
    sed -i "s/'JTL_MINOR_VERSION', '#JTL_MINOR_VERSION#'/'JTL_MINOR_VERSION', '${SHOP_VERSION_PATCH}'/g" ${REPO_DIR}/includes/defines_inc.php
}