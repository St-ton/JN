<div id="settings">
    <form action="{$shopURL}{$route}?action={$action}" method="post" accept-charset="iso-8859-1" id="slider" enctype="multipart/form-data">
        {$jtl_token}
        ...
        <div class="card-footer save-wrapper">
            <div class="row">
                <div class="ml-auto col-sm-6 col-xl-auto">
                    <button type="button" class="btn btn-default btn-block" onclick="window.location.href = '{$shopURL}{$route}';" value="zurück">
                        {__('cancelWithIcon')}
                    </button>
                </div>
