...
try {
    $io->register('getPages', [$jsonApi, 'getPages'])
       ...
       ->register('setWidgetPosition', 'setWidgetPosition', $dashboardInc)
       ->register('closeWidget', 'closeWidget', $dashboardInc)
       ->register('addWidget', 'addWidget', $dashboardInc)
       ->register('expandWidget', 'expandWidget', $dashboardInc)
       ->register('getAvailableWidgets', 'getAvailableWidgetsIO', $dashboardInc)
       ->register('getRemoteData', 'getRemoteDataIO', $dashboardInc)
       ->register('getShopInfo', 'getShopInfoIO', $dashboardInc)
