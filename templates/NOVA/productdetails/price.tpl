        ...
        <div class="price_wrapper">
            ...
            {else}
                {block name='productdetails-price-label'}
                    ...
                    {/if}
                {/block}
                <span class="price {if $tplscope !== 'detail'}productbox-price{/if} text-nowrap{if isset($Artikel->Preise->Sonderpreis_aktiv) && $Artikel->Preise->Sonderpreis_aktiv} special-price{/if}">
