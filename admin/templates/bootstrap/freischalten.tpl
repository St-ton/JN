        ...
        <div class="card-body">
            <div class="row">
                <div class="col-sm-6 col-xl-auto mb-sm-0 mb-3">
                    {include file='tpl_inc/language_switcher.tpl' id='formSprachwechselSelect' action=$shopURL|cat:$route}
                </div>
                <div class="ml-auto col-sm-6 col-xl-auto">
                    <form name="suche" method="post" action="{$shopURL}{$route}">
                        <div class="row">
                            {$jtl_token}
                            <div class="col-sm-6 col-xl-auto mb-sm-0 mb-3">
                                <div class="form-row">
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    <a class="btn btn-link px-2" title="{__('modify')}"
                                                       href="{$adminURL}/reviews?a=editieren&kBewertung={$rating->kBewertung}&nFZ=1&token={$smarty.session.jtl_token}"
                                                       data-toggle="tooltip">
                        ...
                        <form method="post" action="{$shopURL}{$route}">
                            ...
                            <div class="table-responsive">
                                <table class="list table table-striped">
                                    ...
                                    <tr>
                                        <th class="check">&nbsp;</th>
                                        <th class="text-left">(<a href="{$shopURL}{$route}p?tab=livesearch&{$cSuchStr}nSort=1{if !isset($nSort) || $nSort != 11}1{/if}&token={$smarty.session.jtl_token}" style="text-decoration: underline;">{if !isset($nSort) || $nSort != 11}Z...A{else}A...Z{/if}</a>) {__('freischaltenLivesearchSearch')}</th>
                                        <th class="text-center">(<a href="{$shopURL}{$route}?tab=livesearch&{$cSuchStr}nSort=2{if !isset($nSort) || $nSort != 22}2{/if}&token={$smarty.session.jtl_token}" style="text-decoration: underline;">{if !isset($nSort) || $nSort != 22}1...9{else}9...1{/if}</a>) {__('freischaltenLivesearchCount')}</th>
                                        <th class="text-center">(<a href="{$shopURL}{$route}?tab=livesearch&{$cSuchStr}nSort=3{if !isset($nSort) || $nSort != 33}3{/if}&token={$smarty.session.jtl_token}" style="text-decoration: underline;">{if !isset($nSort) || $nSort != 33}0...1{else}1...0{/if}</a>) {__('freischaltenLivesearchHits')}</th>
                                        ...
                                        {foreach $comments as $comment}
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <div class="btn-group">
                                                        <a class="btn btn-link px-2" title="{__('modify')}"
                                                           href="{$adminURL}/news?news=1&kNews={$comment->kNews}&kNewsKommentar={$comment->kNewsKommentar}&nkedit=1&nFZ=1&token={$smarty.session.jtl_token}"
                                                           data-toggle="tooltip">
                                                            <span class="icon-hover">
                                                                <span class="fal fa-edit"></span>
                                                                <span class="fas fa-edit"></span>
                                ...
                                <table class="list table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center">(<a href="{$shopURL}{$route}?tab=newsletter&{$cSuchStr}nSort=4{if !isset($nSort) || $nSort != 44}4{/if}&token={$smarty.session.jtl_token}">{if !isset($nSort) || $nSort != 44}{__('old')}...{__('new')}{elseif isset($nSort) && $nSort == 44}{__('new')}...{__('old')}{/if}</a>) {__('date')}</th>
                                        </tr>
                                    </thead>
                                    <tbody>
