            ...
            <table class="list table table-striped table-align-top">
                ...
                {foreach $packagings as $packaging}
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="btn-group">
                                <a href="{$shopURL}{$route}?kVerpackung={$packaging->kVerpackung}&token={$smarty.session.jtl_token}"
        ...
        <div class="card-footer save-wrapper">
            <div class="row">
                ...
                <div class="{if $packagings|count === 0}ml-auto{/if} col-sm-6 col-xl-auto">
                    <a href="{$shopURL}{$route}?kVerpackung=0&token={$smarty.session.jtl_token}"
