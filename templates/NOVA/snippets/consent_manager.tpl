<div id="consent-manager">
	<div id="consent-banner">
		...
		<div class="consent-banner-body">
			<div class="consent-banner-description">
				...
				<p>{lang key='consentDescription' section='consent' printf=implode(', ', $items)}</p>
			</div>
			...
			<div class="consent-banner-actions">
				<div class="consent-btn-helper">
					...
					<button type="button" class="consent-btn consent-btn-outline-primary" id="consent-banner-btn-close">{lang key='close' section='consent'}</button>
	...
	<div id="consent-settings" class="consent-modal">
		<div class="consent-modal-content">
			...
			<p>{lang key='cookieSettingsDescription' section='consent'}</p>
	...
	<div id="consent-confirm" class="consent-modal">
		...
		<div class="consent-modal-content">
			...
			<p>{lang key='dataProtectionDescription' section='consent'}</p>
