...
<ul class="list-group">
    ...
    <li class="list-group-item boxRow">
        ...
        <div class="col-xs-1">
            ...
            {if isset($oPlzOrt->cImportFile)} <a title="{#plz_ort_import_refresh_desc#}" href="#" data-callback="plz_ort_import_refresh" data-ref="{$oPlzOrt->cImportFile}"><i class="fa fa-import"></i></a>{/if}
        </div>
    </li>
    {/foreach}
</ul>
