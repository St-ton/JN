                            ...
                            <p class="multi_input" style="margin-bottom: 10px;">
                                ...
                                <select id="specialLinkType" name="nSpezialseite">
                                    ...
                                    {foreach $specialPages as $specialPage}
                                        <option value="{$specialPage->getLinkType()}" {if isset($xPostVar_arr.nSpezialseite) && $xPostVar_arr.nSpezialseite === $specialPage->getLinkType()}selected{elseif $Link->getLinkType() === $specialPage->getLinkType()}selected{/if}>{__($specialPage->getName())}</option>
                                    {/foreach}
                                </select>
