...
<fieldset id="payment_creditcard">
    ...
    <div class="row">
        <div class="col-xs-12 col-md-6">    
            <div class="form-group float-label-control crc_no {if isset($fehlendeAngaben.kreditkartennr) && $fehlendeAngaben.kreditkartennr > 0} has-error{/if}">
        ...
        <div class="col-xs-12 col-md-6">  
            <div class="form-group float-label-control crc_vadivd {if isset($fehlendeAngaben.gueltigkeit) && $fehlendeAngaben.gueltigkeit > 0} has-error{/if}">
    ...
    <div class="row">
        <div class="col-xs-12 col-md-6">    
            <div class="form-group float-label-control crc_cvv {if isset($fehlendeAngaben.cvv) && $fehlendeAngaben.cvv > 0} has-error{/if}">
        ...
        <div class="col-xs-12 col-md-6">
            <div class="form-group float-label-control crc_type {if isset($fehlendeAngaben.kartentyp) && $fehlendeAngaben.kartentyp > 0} has-error{/if}">
    ...
    <div class="row">
        <div class="col-xs-12 col-md-6">
            <div class="form-group float-label-control crc_owner {if isset($fehlendeAngaben.inhaber) && $fehlendeAngaben.inhaber > 0} has-error{/if}">
