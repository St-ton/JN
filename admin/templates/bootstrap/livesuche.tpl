...
<div id="content">
    ...
    <div class="tab-content">
        ...
        <div id="einstellungen" class="tab-pane fade {if isset($tab) && $tab === 'einstellungen'} active show{/if}">
            {include file='tpl_inc/config_section.tpl' name='einstellen' a='saveSettings' action='livesuche.php' buttonCaption=__('saveWithIcon') title=__('settings') skipHeading=true tab='einstellungen'}
        </div>
    </div>
</div>
