...
class ImageProvider extends \Faker\Provider\Base
{
    ...
    const TEXT_PAD_MULTIPLIER = 0.1;

    const DEFAULT_TEXT_COLOR = '#ffffff';

    const DEFAULT_TEXT_FORMAT = '%width%x%height%';
    ...
    private static $colors = array(
        '#5b5b95', '#C79810', '#c69d18', '#6BBA70', '#ff6600', '#1393c0', '#4CADD4', '#ff0000', '#277fba', '#57A9FD', '#B71313', '#9AC65C', '#0e63fd',
        '#99cc33', '#3775e2', '#8dbb01', '#ffb640', '#1b5891', '#356AA0', '#e24602', '#4caae4', '#ffcc00', '#cf5700', '#D15600', '#5d82ff', '#00bada',
        '#3b5999', '#0170ca', '#eb003a', '#98cc00', '#bd1d01', '#0061DE', '#FF0084', '#0f0f0f', '#4096EE', '#a71a10', '#025aa2', '#e84c1f', '#FD65C2',
        '#d50000', '#ef9a19', '#96c63f', '#69dbff', '#FFC300', '#9CB6DE', '#D61C39', '#d10039', '#fe198e', '#bedb8a', '#1a7fb3', '#FF7B38', '#ff7638',
        '#3d5381', '#febf0f', '#f28fbf', '#ff910d', '#e51837', '#87c1e7', '#009f59', '#00457B', '#2971AD', '#fa9b65', '#3F4C6B', '#FF1A00', '#003399',
        '#478898', '#62b857', '#006E2E', '#00722d', '#2d9500', '#ec449b', '#5a471c', '#030303', '#ff6200', '#295e92', '#28CF21', '#383121', '#ff4600',
        '#6dc646', '#CC0000', '#FF7400', '#B02B2C', '#e51905', '#c00000', '#f78325', '#924357', '#36393D', '#87be2f', '#6cd0f6', '#03646a', '#00a8aa',
        '#89c122', '#9ac80d', '#6b9cc9', '#6699cc', '#505050', '#21628c', '#e5791e', '#057db9', '#2acc54', '#5ebe8f', '#780000', '#008C00', '#4ABA00',
        '#7f7f7f', '#EA0101', '#003368', '#fcbd00', '#d71920', '#128f34', '#0f0e13', '#174c89', '#64bb69', '#73880A', '#F3AE48', '#4db848', '#fc0234',
        '#d11001', '#ff3237', '#FF6666', '#03a0fa', '#2e2d2e',
    );
    ...
    public static function imageFile($dir = null, $width = 800, $height = 600, $format = 'png', $fullPath = true, $text = null, $textColor = null, $backgroundColor = null, $fontPath = null)
    {
        ...
        $imanee->getDrawer()
            ...
            ->setTextAlign(\Imanee\Drawer::TEXT_ALIGN_LEFT);
        ...
        $imanee->setFormat($format)
            ->placeText($formattedText, \Imanee\Imanee::IM_POS_MID_CENTER, $maxTextWidth)
            ->write($filepath, static::JPEG_QUALITY);
