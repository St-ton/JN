...
<div id="content">
    <form name="uploader" method="post" action="{$shopURL}{$route}" enctype="multipart/form-data" class="hide-fileinput-remove"">
        {$jtl_token}
            ...
            <div class="card-body">
                ...
                <div class="col-xs-12">
                    {include file='tpl_inc/fileupload.tpl'
                        ...
                        fileName='shopLogo'
                        fileUploadUrl="{$shopURL}{$route}?token={$smarty.session.jtl_token}"
                        fileDeleteUrl="{$shopURL}{$route}?token={$smarty.session.jtl_token}"
