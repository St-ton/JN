...
final class CharacteristicModel extends DataModel
{
    ...
    protected function onRegisterHandlers(): void
    {
        ...
        $this->registerSetter('localization', function ($value, $model) {
            ...
            foreach ($value as $data) {
                ...
                try {
                    $loc = CharacteristicLocalizationModel::loadByAttributes($data, $this->getDB(), self::ON_NOTEXISTS_NEW);
                } catch (Exception $e) {
                    continue;
                }
    ...
    public function getAttributes(): array
    {
        ...
        if ($attributes === null) {
            ...
            $attributes['value']        = DataAttribute::create('value', CharacteristicValueModel::class, null, true, false, 'kMerkmal');
            $attributes['localization'] = DataAttribute::create('localization', CharacteristicLocalizationModel::class, null, true, false, 'kMerkmal');
        }
