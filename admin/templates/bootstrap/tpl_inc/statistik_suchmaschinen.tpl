...
<div class="tabs">
    ...
    <div class="tab-content">
        ...
        <div id="settings" class="tab-pane fade {if $cTab === 'settings'} active show{/if}">
            ...
            <form id="crawlerList" name="crawlerList" method="post" action="{$shopURL}{$route}?s=3&tab=settings">
                {$jtl_token}
                <div class="table-responsive">
                        ...
                        {if $crawler_arr|count}
                            {foreach $crawler_arr as $crawler}
                                <tr scope="row" class="tab_bg{$crawler@iteration % 2}">
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group">
                                            <a href="{$shopURL}{$route}?s=3&edit=1&id={$crawler->kBesucherBot}"
                ...
                <div class="card-footer save-wrapper">
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-xl-auto">
                            <a href="{$shopURL}{$route}?s=3&new=1" value="{__('newCrawler')}" class="btn btn-primary btn-block"><i class="fa fa-share"></i> {__('newCrawler')}</a>
                        </div>
                    </div>
                </div>
            </form>
