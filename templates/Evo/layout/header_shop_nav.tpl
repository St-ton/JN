...
<ul class="header-shop-nav nav navbar-nav force-float horizontal pull-right">
    ...
    <li class="hidden-xs wish-list-menu">
        <a href="{get_static_route id='wunschliste.php'}" title="{lang key="goToWishlist" sektion="global"}"><span class="fa fa-heart"></span><sup class="badge"><em>{$smarty.session.Wunschliste->CWunschlistePos_arr|count}</em></sup></a>
    </li>
    {/if}
    {*  WISH LIST *}
