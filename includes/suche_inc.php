 ...
 * @deprecated since 4.06
 */
function suchanfragenSpeichern($cSuche, $hits, $real = false, $kSpracheExt = 0, $bSpamFilter = true)
{
    trigger_error(__FUNCTION__ . ' is deprecated.', E_USER_DEPRECATED);
    return Shop::getProductFilter()->Suche->saveQuery($hits, $cSuche, $real, $kSpracheExt, $bSpamFilter);
}
 ...
 */
function mappingBeachten($query, $kSpracheExt = 0)
{
    trigger_error(__FUNCTION__ . ' is deprecated.', E_USER_DEPRECATED);
