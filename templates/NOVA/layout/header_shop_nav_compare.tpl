...
{block name='layout-header-shop-nav-compare'}
    <li id="shop-nav-compare"
        ...
        class="nav-item dropdown d-none d-md-flex{if $nSeitenTyp === $smarty.const.PAGE_VERGLEICHSLISTE} active{/if} {if empty($smarty.session.Vergleichsliste->oArtikel_arr)}d-none{/if}">
