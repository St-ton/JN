        ...
        <div class="tab-content">
            <div id="overview" class="tab-pane fade{if $cTab === '' || $cTab === 'uebersicht'} active show{/if}">
                {if $invisibleBoxes|count > 0}
                    ...
                    <form action="{$shopURL}{$route}" method="post" class="block">
                        {$jtl_token}
                ...
                {else}
                                    ...
                                    <div class="card-footer save-wrapper">
                                        <div class="row">
                                            <div class="ml-auto col-sm-6 col-xl-auto">
                                                <button type="button" onclick="window.location.href='{$shopURL}{$route}'" class="btn btn-outline-primary btn-block">
                                                    {__('cancelWithIcon')}
                                                </button>
                                            </div>
                    ...
                    {else}
                        ...
                        <div class="card">
                            <div class="card-body">
                                <form name="boxen" method="post" action="{$shopURL}{$route}">
                                    {$jtl_token}
