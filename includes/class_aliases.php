...
class_alias(\JTL\Cache\Methods\cache_advancedfile::class, 'cache_advancedfile', true);
class_alias(\JTL\Cache\Methods\cache_redis::class, 'cache_redis', true);
class_alias(\JTL\Cache\Methods\cache_memcached::class, 'cache_memcached', true);
class_alias(\JTL\Cache\Methods\cache_file::class, 'cache_file', true);
class_alias(\JTL\Cache\Methods\cache_redisCluster::class, 'cache_redisCluster', true);
class_alias(\JTL\Cache\Methods\cache_xcache::class, 'cache_xcache', true);
class_alias(\JTL\Cache\Methods\cache_memcache::class, 'cache_memcache', true);
class_alias(\JTL\Cache\Methods\cache_apc::class, 'cache_apc', true);
class_alias(\JTL\Cache\Methods\cache_null::class, 'cache_null', true);
class_alias(\JTL\Cache\Methods\cache_session::class, 'cache_session', true);
