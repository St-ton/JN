                ...
                <span class="input-group-wrap last">
                    <select id="kSprache" name="kSprache" class="form-control selectBox" onchange="document.sprache.submit();">
                        {foreach $sprachen as $language}
                            <option value="{$language->getId()}" {if $sprache->getId() === $smarty.session.kSprache}selected{/if}>{$sprache->getLocalizedName()}</option>
                        {/foreach}
                    </select>
                </span>
            </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select id="nEdit" name="nEdit" class="{if isset($xPlausiVar_arr.nEdit)} fieldfillout{/if} form-control">
                                        ...
                                        <option value="0"{if (isset($xPostVar_arr.nEdit) && $xPostVar_arr.nEdit == 0) || (isset($oKundenfeld->nEditierbar) && $oKundenfeld->nEditierbar == 1)} selected{/if}>
                                            {__('no')}
                                        </option>
                                    </select>
                                </td>
