        ...
        <fieldset>
            ...
            <div id="invoicebusiness_information">
                ...
                <div class="radio">
                    <label for="billpay_b2b_no">
                        ...
                        Privatkunde<span class="optional"> - {lang key='optional' section='checkout'}</span>
                    </label>
                </div>
                {*/if*}
                ...
                <div class="radio">
                    <label for="billpay_b2b_yes">
                        ...
                        Gesch&auml;ftskunde<span class="optional"> - {lang key='optional' section='checkout'}</span>
                    </label>
                </div>
                {*/if*}
            </div>
            ...
            <div class="{if $cData_arr.billpay_b2b == 1}closed{/if}" id="invoicebusiness_b2c">
                {if $cAdditionalCustomer_arr.cAnrede}
                    <div class="form-group{if $cMissing_arr.cAnrede > 0} has-error{/if}">
                ...
                {if $cAdditionalCustomer_arr.dGeburtstag}
                    <div class="form-group{if $cMissing_arr.dGeburtstag > 0} has-error{/if}">
                        <label class="control-label col-xs-4" for="dGeburtstag">{lang key='birthday' section='account data'}<span class="optional"> - {lang key='optional' section='checkout'}</span></label>
                        <div class="col-xs-8">
                ...
                {if $cAdditionalCustomer_arr.cTel}
                    <div class="form-group{if $cMissing_arr.cTel > 0} has-error_block{/if}" id="tel" {*if (($nPaymentTypes_arr[1] || $nPaymentTypes_arr[2]) && $cData_arr.billpay_paymenttype != 3)}style="display:none"{/if*}>
                ...
                <div class="row">
                    <div class="col-xs-12 col-md-6">
                        <div class="form-group float-label-control">
                            ...
                            <label for="firstName" class="control-label">{lang key='salutation' section='account data'}<span class="optional"> - {lang key='optional' section='checkout'}</span></label></div>
                    </div>
                    <div class="col-xs-12 col-md-6">
                        <div class="form-group float-label-control">
            ...
            *}
                <div class="form-group{if $cMissing_arr.cRechtsform > 0} has-error{/if}">
                ...
                <div class="form-group{if $cMissing_arr.cFirma > 0} has-error{/if}">
                ...
                <div class="form-group{if $cMissing_arr.cUSTID > 0} has-error{/if}">
                    <label class="control-label" for="cUSTID">USt-IdNr.<span class="optional"> - {lang key='optional' section='checkout'}</span></label>
                ...
                <div class="form-group{if $cMissing_arr.cHrn > 0} has-error{/if}">
                    <label class="control-label" for="cHrn">Handelsregisternummer<span class="optional"> - {lang key='optional' section='checkout'}</span></label>
