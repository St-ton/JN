                        ...
                        <table class="list table">
                            <thead>
                                <tr>
                                    ...
                                    {if $cKuponTyp === $couponTypes.standard || $cKuponTyp === $couponTypes.newCustomer}<th>{#value#}</th>{/if}
...
<div id="content" class="container-fluid">
    <ul class="nav nav-tabs" role="tablist">
        <li class="tab{if $tab === $couponTypes.standard} active{/if}">
            <a data-toggle="tab" role="tab" href="#{$couponTypes.standard}" aria-expanded="false">{#standardCoupon#}s</a>
        </li>
        <li class="tab{if $tab === $couponTypes.shipping} active{/if}">
            <a data-toggle="tab" role="tab" href="#{$couponTypes.shipping}" aria-expanded="false">{#shippingCoupon#}s</a>
        </li>
        <li class="tab{if $tab === $couponTypes.newCustomer} active{/if}">
            <a data-toggle="tab" role="tab" href="#{$couponTypes.newCustomer}" aria-expanded="false">{#newCustomerCoupon#}s</a>
        </li>
    </ul>
