    ...
    <div class="tabs">
        ...
        <div class="tab-content">
            <div id="overview" class="tab-pane fade{if $cTab === '' || $cTab === 'uebersicht'} active show{/if}">
                <form name="kundenfeld" method="post" action="{$shopURL}{$route}">
                    {$jtl_token}
                                ...
                                <table class="table table-striped table-align-top">
                                    ...
                                    {foreach $oKundenfeld_arr as $oKundenfeld}
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    <a href="{$shopURL}{$route}?a=edit&kKundenfeld={$oKundenfeld->kKundenfeld}&tab=uebersicht&token={$smarty.session.jtl_token}"
            ...
            <div id="config" class="tab-pane fade{if $cTab === 'einstellungen'} active show{/if}">
                {include file='tpl_inc/config_section.tpl' name='einstellen' a='saveSettings' action=$shopURL|cat:$route buttonCaption=__('save') tab='einstellungen'}
            </div>
        </div>
    </div>
</div>
