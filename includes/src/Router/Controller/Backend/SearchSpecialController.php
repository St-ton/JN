...
class SearchSpecialController extends AbstractBackendController
{
    ...
    public function getResponse(ServerRequestInterface $request, array $args, JTLSmarty $smarty): ResponseInterface
    {
        ...
        if (Request::verifyGPCDataInt('einstellungen') === 1) {
            ...
            if (\mb_strlen($bestSellerSeo) > 0 && !$this->pruefeSuchspecialSeo(
                $searchSpecials,
                $bestSellerSeo,
            ...
            if (\mb_strlen($specialOffersSeo) > 0 && !$this->pruefeSuchspecialSeo(
                $searchSpecials,
                $specialOffersSeo,
            ...
            if (\mb_strlen($newProductsSeo) > 0 && !$this->pruefeSuchspecialSeo(
                $searchSpecials,
                $newProductsSeo,
            ...
            // Pruefe Top Angebote
            if (\mb_strlen($topOffersSeo) > 0 && !$this->pruefeSuchspecialSeo(
                $searchSpecials,
                $topOffersSeo,
            ...
            if (\mb_strlen($releaseSeo) > 0 && !$this->pruefeSuchspecialSeo(
                $searchSpecials,
                $releaseSeo,
            ...
            // Pruefe Top bewertet
            if (\mb_strlen($topRatedSeo) > 0 && !$this->pruefeSuchspecialSeo(
                $searchSpecials,
                $topRatedSeo,
     ...
     */
    private function pruefeSuchspecialSeo(array $searchSpecials, string $seo, int $key): bool
    {
