...
<br>
wunschgem�� haben wir f�r Sie in unserem Onlineshop unter
<strong><a href="{$ShopURL}" target="_blank" style="color: #313131;">{$ShopURL}</a></strong> ein Kundenkonto f�r Sie eingerichtet.<br>
<br>
