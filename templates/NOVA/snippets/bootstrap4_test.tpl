...
<div class="card">
    ...
    <div class="bd-example">
        <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item">
                    <img class="d-block w-100" alt="First slide [800x400]" src="gfx/keinBild.gif" data-holder-rendered="true">
                ...
                <div class="carousel-item">
                    <img class="d-block w-100" alt="Second slide [800x400]" src="gfx/keinBild.gif" data-holder-rendered="true">
                    <div class="carousel-caption d-none d-md-block">
                ...
                <div class="carousel-item active">
                    <img class="d-block w-100" alt="Third slide [800x400]" src="gfx/keinBild.gif" data-holder-rendered="true">
                    <div class="carousel-caption d-none d-md-block">
