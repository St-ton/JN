                                        ...
                                        <td class="text-center">
                                            <div class="btn-group">
                                                <a class="btn btn-link px-2 delete-confirm"
                                                   href="{$shopURL}{$route}?action=delete&id={$oSlider->kSlider}&token={$smarty.session.jtl_token}"
                                                   title="{__('delete')}"
                                                   data-toggle="tooltip"
                                                ...
                                                <a class="btn btn-link px-2 add"
                                                   href="{$shopURL}{$route}?action=slides&id={$oSlider->kSlider}&token={$smarty.session.jtl_token}"
                                                   title="{__('slides')}"
                                                   data-toggle="tooltip">
                                                    <span class="icon-hover">
                                                ...
                                                <a class="btn btn-link px-2"
                                                   href="{$shopURL}{$route}?action=edit&id={$oSlider->kSlider}&token={$smarty.session.jtl_token}"
                                                   title="{__('modify')}"
                                                   data-toggle="tooltip">
                                                    <span class="icon-hover">
