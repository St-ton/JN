...
{if !empty($cKuponfehler_arr.ungueltig)}
    {if $cKuponfehler_arr.ungueltig == 1}
        <div class="alert alert-danger">{lang key='couponErr1' section='global'}</div>
    {elseif $cKuponfehler_arr.ungueltig == 2}
        <div class="alert alert-danger">{lang key='couponErr2' section='global'}</div>
    {elseif $cKuponfehler_arr.ungueltig == 3}
        <div class="alert alert-danger">{lang key='couponErr3' section='global'}</div>
    {elseif $cKuponfehler_arr.ungueltig == 4}
        <div class="alert alert-danger">{lang key='couponErr4' section='global'}</div>
    {elseif $cKuponfehler_arr.ungueltig == 6}
        <div class="alert alert-danger">{lang key='couponErr6' section='global'}</div>
    {elseif $cKuponfehler_arr.ungueltig == 9}
        <div class="alert alert-danger">{lang key='couponErr9' section='global'}</div>
    {elseif $cKuponfehler_arr.ungueltig == 11}
        <div class="alert alert-danger">{lang key='invalidCouponCode' section='checkout'}</div>
    {elseif $cKuponfehler_arr.ungueltig == 12}
        <div class="alert alert-danger">{lang key='invalidCouponCode' section='checkout'}</div>
    {else}
