                                    ...
                                    <div class="form-group form-row align-items-center">
                                        ...
                                        <div class="col-sm pl-sm-3 pr-sm-5 order-last order-sm-2">
                                            <input class="form-control" type="text" name="cMetaTitle_{$cISO}"
                                                   id="cMetaTitle_{$cISO}"
                                                   value="{if isset($xPostVar_arr.$cMetaTitle_ISO) && $xPostVar_arr.$cMetaTitle_ISO}{$xPostVar_arr.$cMetaTitle_ISO}{elseif !empty($Link->getMetaTitle($langID))}{$Link->getMetaTitle($langID)}{/if}"
                                                   tabindex="9" />
                                        </div>
                                        <div class="col-auto ml-sm-n4 order-2 order-sm-3">
                                    ...
                                    <div class="form-group form-row align-items-center">
                                        ...
                                        <div class="col-sm pl-sm-3 pr-sm-5 order-last order-sm-2">
                                            <input class="form-control" type="text"
                                                   ...
                                                   value="{if isset($xPostVar_arr.$cMetaKeywords_ISO) && $xPostVar_arr.$cMetaKeywords_ISO}{$xPostVar_arr.$cMetaKeywords_ISO}{elseif !empty($Link->getMetaKeyword($langID))}{$Link->getMetaKeyword($langID)}{/if}"
                                                   tabindex="9" />
                                        </div>
                                        <div class="col-auto ml-sm-n4 order-2 order-sm-3">
                                    ...
                                    <div class="form-group form-row align-items-center">
                                        ...
                                        <div class="col-sm pl-sm-3 pr-sm-5 order-last order-sm-2">
                                            <input class="form-control" type="text"
                                                   ...
                                                   value="{if isset($xPostVar_arr.$cMetaDescription_ISO) && $xPostVar_arr.$cMetaDescription_ISO}{$xPostVar_arr.$cMetaDescription_ISO}{elseif !empty($Link->getMetaDescription($langID))}{$Link->getMetaDescription($langID)}{/if}"
                                                   tabindex="9" />
                                        </div>
                                        <div class="col-auto ml-sm-n4 order-2 order-sm-3">
