...
wir freuen uns, Ihnen mitteilen zu dürfen, dass in unserem Onlineshop folgender Kupon ({$Kupon->AngezeigterName}) für Sie bereitliegt:
...
{/if}{if $Kupon->nVerwendungenProKunde>1}Sie dürfen diesen Kupon für insgesamt {$Kupon->nVerwendungenProKunde} Einkäufe bei uns nutzen.

{elseif $Kupon->nVerwendungenProKunde==0}Sie dürfen diesen Kupon für beliebig viele Einkäufe bei uns nutzen.

{/if}{if $Kupon->nVerwendungen>0}Bitte beachten Sie, dass dieser Kupon auf eine maximale Verwendungsanzahl begrenzt ist.
