...
<head>
    ...
    <link rel="stylesheet" href="{$URL_SHOP}/{$PFAD_ADMIN}{$currentTemplateDir}assets/dist/preload.css">
    <link rel="stylesheet" href="{$URL_SHOP}/{$PFAD_ADMIN}{$currentTemplateDir}assets/dist/app.css">
    {*<script src="http://localhost:25487/livereload.js"></script>*}
    <script src="{$URL_SHOP}/{$PFAD_ADMIN}{$currentTemplateDir}assets/dist/manifest.js"></script>
    <script src="{$URL_SHOP}/{$PFAD_ADMIN}{$currentTemplateDir}assets/dist/vendor.js"></script>
    <script src="{$URL_SHOP}/{$PFAD_ADMIN}{$currentTemplateDir}assets/dist/app.js"></script>
    {$admin_js}
...
{if $account !== false && isset($smarty.session.loginIsValid) && $smarty.session.loginIsValid === true}
    ...
    <div class="spinner backend-wrapper container-fluid{if $currentPage === 'index' || $currentPage === 'status'} dashboard{/if}"></div>
    <div id="page-wrapper" class="hidden disable-transitions">
        ...
        <main role="main" id="content_wrapper">
