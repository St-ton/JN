                            ...
                            <tr class="tab_bg{$smarty.foreach.wunschliste.iteration%2}">
                                <td class="TD1">
                                    {if $CWunschliste->nOeffentlich == 1}
                                        <a href="{Shop::getURL()}/index.php?wlid={$CWunschliste->cURLID}" rel="external">{$CWunschliste->cName}</a>
                                    {else}
                    ...
                    <table class="table">
                        ...
                        {foreach name=wunschlistepos from=$CWunschlistePos_arr item=CWunschlistePos}
                            <tr class="tab_bg{$smarty.foreach.wunschlistepos.iteration%2}">
                                <td class="TD1">
                                    <a href="{Shop::getURL()}/index.php?a={$CWunschlistePos->kArtikel}&" rel="external">{$CWunschlistePos->cArtikelName}</a>
                                </td>
                    ...
                    <table class="table">
                        ...
                        {foreach name=wunschlisteversand from=$CWunschlisteVersand_arr item=CWunschlisteVersand}
                            <tr class="tab_bg{$smarty.foreach.wunschlisteversand.iteration%2}">
                                <td class="TD1">
                                    <a href="{Shop::getURL()}/index.php?wlid={$CWunschlisteVersand->cURLID}" rel="external">{$CWunschlisteVersand->cName}</a>
                                </td>
