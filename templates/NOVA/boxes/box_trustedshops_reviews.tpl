 ...
 *}
{block name='boxes-box-trusted-shops-reviews'}
    {card
        ...
        <hr class="mt-0 mb-4">
        {block name='boxes-box-trusted-shops-reviews-content'}
            ...
            <span class="review-aggregate">
                ...
                {link href=$oBox->getImageURL() title=$cShopName}
                    {lang key='rating'} {lang key='from'} {$cShopName}
                {/link}
            </span>
        {/block}
    {/card}
