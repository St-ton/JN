...
{if $Kunde->cTel}Tel.: {$Kunde->cTel|substr:1}****{$Kunde->cTel|substr:-4}
{/if}{if $Kunde->cMobil}Mobil: {$Kunde->cMobil|substr:1}****{$Kunde->cMobil|substr:-4}
...
{if !empty($Bestellung->Lieferadresse->kLieferadresse)}
    ...
    {if $Bestellung->Lieferadresse->cTel}Tel.: {$Bestellung->Lieferadresse->cTel|substr:1}****{$Bestellung->Lieferadresse->cTel|substr:-4}
    {/if}{if $Bestellung->Lieferadresse->cMobil}Mobil: {$Bestellung->Lieferadresse->cMobil|substr:1}****{$Bestellung->Lieferadresse->cMobil|substr:-4}
