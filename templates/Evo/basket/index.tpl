...
{if ($Warenkorb->PositionenArr|@count > 0)}
    ...
    {block name="basket"}
        <div class="basket_wrapper">
            <form id="cart-form" method="post" action="{get_standard_link id='warenkorb.php'}">
                {$jtl_token}
            ...
            <form id="basket-coupon-form" method="post" action="{get_standard_link id='warenkorb.php'}">
                {$jtl_token}
            ...
            <form id="basket-shipping-estimate-form" method="post" action="{get_standard_link id='warenkorb.php'}">
                {$jtl_token}
                                    ...
                                    <div class="panel-body">
                                        {block name="basket-shipping-estimated-body"}
                                            ...
                                            {if !empty($Versandarten)}
                                                ...
                                                <a href="{get_standard_link id='warenkorb.php'}" class="btn btn-default">{lang key="newEstimation" section="checkout"}</a>
                                            {else}
                    ...
                    <div id="freegift" class="panel panel-info">
                        ...
                        <div class="panel-body">
                            {block name="basket-freegift-body"}
                                <form method="post" name="freegift" action="{get_standard_link id='warenkorb.php'}">
                                    {$jtl_token}
